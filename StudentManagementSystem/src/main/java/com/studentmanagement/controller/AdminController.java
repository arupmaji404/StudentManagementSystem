...
public class AdminController {
	...
	public String addAdmin(@Valid @ModelAttribute("admin") AdminModel admin, BindingResult result,  @RequestParam("password") String pass) {
	...
	public String editAdmin(@Valid @ModelAttribute("admin") AdminModel admin, BindingResult result) {
		if(result.hasErrors())
		{
			return "admin/adminUpdate";
		}
	...
	public String addStudent(@Valid @ModelAttribute("student") StudentModel student, BindingResult result, @RequestParam("password") String pass) {
		if(result.hasErrors())
		{
			return "admin/add-student-form";
		}
	...
	public String editStudent(@Valid @ModelAttribute("student") StudentModel student, BindingResult result) {
		if(result.hasErrors())
		{
			return "admin/studentUpdate";
		}
